...
const About = () => {
  return (
    <div className="container mx-auto py-20 px-6">
      <h5 className="text-5xl mb-6">About Me</h5>
      <p className="mb-3">
        Hola! I'm Nur. A Front-end Developer working remotely from Dhaka,
        Bangladesh.
      </p>
      <p className="mb-3">
        I've spent most of my last waking hours for the last 2 years in learning
        and developing cool but practical user interfaces for websites.
      </p>
      <p className="mb-3">
      ...
      <h5 className="text-5xl mt-20 mb-6">Tech Stack</h5>
      <p>
